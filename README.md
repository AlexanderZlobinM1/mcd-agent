...
Preset rules:
- `tiny`: single ring, no throttle, no whitelists, segments `1`; campaigns use one worker in chain mode (`rebuild -> trigger` for the same id), newest-first published list.
